...
| D-007 | 2026-08-05 | **Piso de R$ 5.000 para o P2 (Operação)** | Nicolas | Triangulação de 3 rotas independentes: conselho 13/07, regra de 30%, faixa de mercado BR | Nenhuma venda de P2 abaixo disso sem exceção aprovada | ✅ **DECIDIDO** |
| D-008 | 2026-08-05 | **Subir o ICP**, com duas faixas: R$ 25–50 mil e R$ 50 mil+ | Nicolas | Loja pequena não sustenta o preço que a operação exige | Muda o discurso comercial e a qualificação de lead | ✅ **DECIDIDO** — faixa a recalibrar, ver `15` |

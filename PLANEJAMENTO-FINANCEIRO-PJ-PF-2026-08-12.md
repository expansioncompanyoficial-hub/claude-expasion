# PLANEJAMENTO FINANCEIRO PJ/PF — O PAPO COM O ANTÔNIO
**Fonte:** áudio transcrito automaticamente (qualidade baixa) — bruta em `_audios/transcricao-papo-antonio-2026-08-12-bruta.md`, organizada por falante em `_audios/transcricao-papo-antonio-2026-08-12-organizada.md`
**Data de registro:** 12/08/2026
**Participantes:** Nicolas e Antônio (dono do hub / encontro de negócios)
**Complementa:** pesquisa pública sobre a W1 Consultoria feita em 12/08/2026 (fontes na seção 8)

> Quatro pautas num papo só: o modelo de planejamento financeiro PJ/PF que o Antônio mandou copiar, a estratégia de conexões, o formato do encontro de negócios e a ponte do Cleber com o mundo do luxo. Este documento separa **o que foi dito**, **o que a pesquisa e o acervo confirmam** e **o que merece freio**.

---

## 1. QUEM É QUEM (cruzado com o acervo)
...
## 2. A PAUTA-TÍTULO: PLANEJAMENTO FINANCEIRO PJ/PF

### O que o Antônio apresentou

Um consultor que passou **2 anos na W1 Consultoria**, saiu e montou a própria operação copiando a metodologia ("control C e control V"). O desenho, na palavra do Antônio:

1. **Quantidade, público mais baixo** — empresários pequenos, que começaram agora e estão **com problemas de gestão**.
2. Pega experiência nos pequenos e **"vai pros grandes"**.
3. Uma **metodologia para rentabilizar** o cliente — e aí **"vem de vários serviços depois"** (esteira de venda sequencial).
4. O treinamento interno também é replicável: "é tudo tipo control C e control V, de uma metodologia deles".

O consultor procurou o hub para acelerar e avaliar sociedade — mas "arrancou demais, emocionou, veio com um monte de investimento". A sugestão do Antônio ao Nicolas: **estudar a W1, ver como se torna consultor, e "dar uma copiada" na linha** (não no todo: "não muito... às vezes você pode ir nessa linha").
...
| Peça | Como funciona na W1 |
|---|---|
| **Porta de entrada remunerada** | O planejamento (diagnóstico 360º + plano) é cobrado como **fee** — percentual da renda bruta anual do cliente, ou assinatura com direito a reuniões |
| **Esteira de cross-sell** | O plano tem **5 pilares fixos** (organização financeira, expansão patrimonial, acúmulo de capital, proteção/blindagem, sucessão) — e **cada pilar é gatilho de venda comissionada**: seguro de vida, previdência, consórcio, investimento, crédito, tributário |
| **PF e PJ no mesmo cliente** | Atende o empresário como PF e a empresa dele via W1 Business (consultoria para PME) e W1 Corporate (crédito PJ) — a ponte PF↔PJ do papo já existe no original |
| **Carteira pequena e recorrente** | **30 clientes por consultor, teto de 60** — viável para operação enxuta |
| **Consultor formado do zero** | Não exige experiência: **formação gratuita de ~6 meses**, consultor é PJ/associado, **remuneração 100% variável**, plano de carreira até partnership. 2.200 vagas anunciadas em 2024 |

É exatamente esse desenho que explica o "control C, control V": **em 2 anos dentro da casa, um consultor absorve o processo inteiro** — script de diagnóstico, pilares, esteira de produtos, gestão de carteira. O ativo é o processo padronizado, não o talento individual. Se a W1 forma leigo em 6 meses, o método é documentável por definição.

### O que se copia e o que não se copia

- **Copiável:** o formato de monetização em duas camadas (fee de diagnóstico + esteira de implementação), a estrutura de plano em pilares fixos, a carteira 30–60, o foco em empresário pequeno com dor de gestão — que, aliás, **é o mesmo ICP que a Expansion já atende na agência**.
- **Não copiável no curto prazo:** a receita de distribuição (a W1 Capital é plugada na XP; comissão de seguradora/administradora exige credenciamento), a marca e a máquina de recrutamento em massa.
- **O que o papo não disse:** planejamento financeiro com recomendação de investimento é **atividade regulada** (consultoria de valores mobiliários exige registro CVM; distribuição exige vínculos formais). Dá para operar no território de **gestão/organização financeira de PME** sem tocar produto regulado — é onde o "consultor ex-W1" do hub parece atuar — mas a fronteira precisa ser desenhada antes de vender, não depois.

---

## 3. ESTRATÉGIA DE CONEXÕES — os conselhos do Antônio

O contexto do Nicolas: furou a bolha via **Prime** (acesso a empresários grandes e ecossistemas), tem a **ITC Energia** para indicar, e quer usar as conexões "de forma inteligente" — deixando claro que o que ele faz é **conexão real com lastro** ("o cara confia na minha palavra, vai lá e dá negócio"), não networking de crachá.

Os três conselhos do Antônio, em ordem do que ele mais repetiu:

1. **Curadoria antes da indicação.** "Tem muito picarete." Validar sempre ("diga lá, Antônio, o cara é bom mesmo?") — a moeda desse jogo é a palavra de quem indica.
2. **Presença constante ou a conexão morre.** "Não pode ficar longe... vai esfriando, vai esfriando e aí entra outro." Conexão sem recorrência é carteira que se desvaloriza.
3. **Conexão agora é linha de receita.** "Tem um monte de produto que dá pra vocês ganhar em cima — oferecendo um serviço daqui e levando pra outra pessoa, e ao contrário. As conexões vão fazer você ganhar grana agora." O próprio Antônio diz que **pivotou o hub para isso**: "quando o cara entra aqui, meu foco é pensar no que eu consigo conectar o cara pra fazer dinheiro".

O anti-modelo citado é o próprio Darlan, na fala que o Antônio ouviu no camarim: *"eu não entrego nada, eu conecto o pessoal, acordo com o celular na mão e durmo com o celular na mão"* — conexão pura, sem entrega, funciona para quem dá valor e desgasta quem esperava mais (ver seção 5).
...
## 5. CLEBER, LUXO E ECOSSISTEMAS PAGOS
...
5. **Indicação é passivo contingente.** Nicolas indica na palavra; o Antônio mesmo alertou do excesso de picarete. Cada indicação ruim queima a carteira inteira de conexões — vale adotar o protocolo que o próprio Antônio usa: validação com terceiro antes de apresentar.

---

## 8. FONTES DA PESQUISA W1 (12/08/2026)

Institucionais: [w1.com.br](https://www.w1.com.br/) · [quem-somos](https://www.w1.com.br/quem-somos) · [w1-consultoria](https://www.w1.com.br/w1-consultoria) · [seja-consultor](https://www.w1.com.br/seja-consultor) · [seja-assessor](https://www.w1.com.br/seja-assessor) · [w1-capital](https://www.w1.com.br/w1-capital) · [consultoria patrimonial](https://www.w1.com.br/w1-consultoria-patrimonial) · [w1inc.com.br](https://www.w1inc.com.br/pt-BR)

Imprensa: [InfoMoney — planejamento 360º](https://www.infomoney.com.br/onde-investir/w1-consultoria-se-consolida-como-consultoria-focada-em-planejamento-financeiro-360o/) · [InfoMoney — 2.200 vagas](https://www.infomoney.com.br/advisor/profissao/w1-abre-2-200-vagas-para-consultor-financeiro-e-assessor-de-investimentos/) · [Exame](https://exame.com/negocios/consultoria-w1-solucoes-financeiras/) · [BP Money — captação R$ 2 bi](https://bpmoney.com.br/bpm-escuta/grupo-w1-estima-captacao-de-r-2-bi-e-faturamento-milionario/) · NeoFeed (4 matérias — **brand stories pagas pela W1**, usar como autodeclaração, não como fonte independente)

Bastidor de carreira: Glassdoor e Indeed (avaliações de consultores — confirmam modelo PJ/100% variável).

---

*Par deste parecer: transcrições bruta e organizada em `_audios/`. Rodadas futuras sobre o tema viram arquivo novo (`-RODADA2`), conforme a convenção da casa.*
